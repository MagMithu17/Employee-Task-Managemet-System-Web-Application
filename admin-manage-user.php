...
if(isset($_GET['delete_user'])){
  ...
  $task_sql = "DELETE FROM task_info WHERE t_user_id = :action_id"; // Using a prepared statement
  $delete_task = $obj_admin->db->prepare($task_sql);
  ...
  $attendance_sql = "DELETE FROM attendance_info WHERE atn_user_id = :action_id"; // Using a prepared statement
  $delete_attendance = $obj_admin->db->prepare($attendance_sql);
...
if(isset($_SESSION['update_user_pass'])){
  ...
  echo '<script>alert("Password reset successful. A temporary password has been set");</script>';
